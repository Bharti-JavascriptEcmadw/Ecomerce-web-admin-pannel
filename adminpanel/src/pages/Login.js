    ...
    return (
        <div className="flex min-h-screen bg-teal-800 justify-center items-center">
            <div className="bg-blue-200 shadow-lg rounded-lg p-8 w-full max-w-md">
                ...
                <form className="mt-6" onSubmit={handleLogin}> {/* ✅ Form submit correctly handled */}
                    <div className="mb-4">
                    ...
                    <button 
                        type="submit"  // ✅ Now works correctly for form submission
                ...
                <div className="text-center mt-4">
                    <p className="text-gray-600">
                        ...
                        <button onClick={() => navigate("/")} className="text-blue-500 font-bold hover:underline">
                            Sign Up
                        </button>
                    </p>
                </div>
